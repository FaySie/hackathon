...
use Admin\Record\TaskImageMapRecord;
use Admin\Table\Table;
use Windwalker\DataMapper\AbstractDatabaseMapperProxy;
use Windwalker\Event\Event;

/**
 * The TaskImageMapMapper class.
 * 
 * @since  1.0
 */
class TaskImageMapMapper extends AbstractDatabaseMapperProxy
{
	/**
	 * Property table.
	 *
	 * @var  string
	 */
	protected static $table = Table::TASK_IMAGE_MAPS;
	 ...
	 * @var  string
	 */
	protected static $dataClass = TaskImageMapRecord::class;
