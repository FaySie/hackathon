	...
	protected function doDefine(Form $form)
	{
		...
		$this->group('search', function (Form $form)
		{
			...
			$this->list('field')
				...
				->option(Translator::translate('admin.project.field.title'), 'project.title')
				->option(Translator::translate('admin.project.field.alias'), 'project.alias');
		...
		$this->group('filter', function(Form $form)
		{
			...
			$this->list('project.state')
				...
				->option('', '')
				->option(Translator::translate('admin.project.filter.state.select'), '')
